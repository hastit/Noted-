      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-[#f8f9fa] px-6">
        <div className="max-w-md space-y-4 text-center">
          ...
          <p className="text-sm leading-relaxed text-black/50">
            Configure <code className="rounded bg-black/5 px-1.5 py-0.5 text-xs">VITE_SUPABASE_URL</code> and{' '}
            <code className="rounded bg-black/5 px-1.5 py-0.5 text-xs">VITE_SUPABASE_ANON_KEY</code> (or NEXT_PUBLIC_ / EXPO_PUBLIC_ variants) in{' '}
